...
$FullImageNameLatest = "$DockerHubUsername/$ImageName`:devLatest"

# Build Arguments (Set these values as needed)
# For sensitive keys, consider using environment variables or prompting the user
$Env:NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY_BUILD_ARG = "pk_test_Z29sZGVuLXdhbGxhYnktOS5jbGVyay5hY2NvdW50cy5kZXYk"
$Env:NEXT_PUBLIC_CLERK_DOMAIN_BUILD_ARG = "dev.zabari.online"
$Env:NEXT_PUBLIC_SITE_URL_BUILD_ARG = "https://dev.zabari.online"
